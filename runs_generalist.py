...
ea_function = run_eaSimple_generalist
# ea_function = run_muPlusLambda_generalist
...
for enemy_group in enemy_groups:
    for run_num in range(1, n_runs + 1):
        ...
        if ea_function.__name__ == "run_eaSimple_generalist":
            experiment_name = 'runs_eaSimple_generalist'
        elif ea_function.__name__ == "run_muPlusLambda_generalist":
