...
from deap_eaMuPlusLambda import run_muPlusLambda
...
for enemy in enemies:
    for run_num in range(1, n_runs + 1):
        print(f"\nRUNNING EVOLUTION FOR ENEMY {enemy}, RUN {run_num}\n")
        
        if ea_function.__name__ == "run_eaSimple":
            experiment_name = 'runs_eaSimple'
        elif ea_function.__name__ == "run_muPlusLambda":
            experiment_name = 'runs_muPlusLambda'
